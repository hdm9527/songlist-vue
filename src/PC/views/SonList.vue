<template>
  <div>
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-input placeholder="歌名/歌手/类型" v-model="queryInfo.nameOrArtist" @keydown.enter.native="getSongList">
      ...
      <el-table
        ...
        <el-table-column label="类型" prop="language" sortable="custom"></el-table-column>
    ...
    <el-dialog
      ...
      <el-form ref="addFormRef" :rules="songRules" :model="editForm" label-width="70px">
        ...
        <el-form-item label="类型" prop="language">
          <el-input placeholder="中文/英语/日语/ACG/其他类型" v-model="editForm.language" @keydown.enter.native="addSong"></el-input>
        </el-form-item>
      </el-form>
  ...
  data() {
    return {
      ...
      songRules: {
        ...
        language: [{ required: true, message: '请输入歌曲类型！', trigger: 'blur' }]
      },
      // 编辑参数
      editForm: {
        id: 0,
